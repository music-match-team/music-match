...
export default function ProfiloPage() {
  ...
  const [immagineProfilo, setImmagineProfilo] = useState<string | null>(null);
    ...
    async function caricaProfilo() {
      try {
        ...
        if (response.ok) {
          ...
          if (data.immagineProfilo) setImmagineProfilo(data.immagineProfilo);
  ...
  async function salvaProfilo() {
    try {
      ...
      const nuovoUtente = { ...utente, username, immagineProfilo };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 shadow-xl backdrop-blur-sm">
                ...
                {/* Profilo Header (Immagine e Username) */}
                <div className="flex items-center gap-6 mb-8 border-b border-zinc-800 pb-6">
                  <div 
                    onClick={() => document.getElementById('galleria-media')?.scrollIntoView({ behavior: 'smooth' })}
                    title="Modifica Immagine Profilo"
                    className="w-24 h-24 rounded-full border-2 border-zinc-700 overflow-hidden bg-zinc-800 shrink-0 cursor-pointer group hover:border-[#0ea5e9] transition-all relative"
                  >
                    {immagineProfilo ? (
                       <img src={immagineProfilo} alt="Immagine Profilo" className="w-full h-full object-cover group-hover:opacity-60 transition-opacity" />
                    ) : (
                       <div className="w-full h-full flex items-center justify-center text-zinc-500 font-bold text-3xl group-hover:opacity-60 transition-opacity">
                  ...
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-zinc-800/70 border border-zinc-700 rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#22d3ee] transition-all"
                    />
                  </div>
                </div>

                <h2 className="text-xl font-bold text-white mb-4 border-b border-zinc-800 pb-2 flex items-center gap-2">
                  <svg className="w-5 h-5 text-[#22d3ee]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                  Dati Geografici e Bio
                </h2>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-2.5 bg-zinc-800/70 border border-zinc-700 rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#22d3ee] focus:border-transparent transition-all"
                      />
                    ...
                    {cittaSelezionata && (
                      <div className="mt-2.5 flex items-center gap-2 text-xs text-[#22d3ee] bg-[#22d3ee]/30 border border-[#22d3ee]/50 py-1.5 px-3 rounded-md w-fit">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full px-4 py-2.5 bg-zinc-800/70 border border-zinc-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#22d3ee] transition-all appearance-none cursor-pointer"
                      >
                      ...
                      return (
                        <button
                          ...
                          className={`px-4 py-2 rounded-full text-xs font-semibold border transition-all cursor-pointer flex items-center gap-1.5 ${
                            selected
                              ? "bg-[#22d3ee]/90 border-[#22d3ee] text-white shadow-md shadow-[#22d3ee]/20"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 shadow-xl backdrop-blur-sm">
                ...
                <div className="mb-4 p-4 rounded-xl bg-[#22d3ee]/20 border border-[#22d3ee]/40">
                  ...
                  <div className="w-full bg-zinc-950/50 rounded-full h-2.5 overflow-hidden mb-3 border border-zinc-800/50">
                    <div className="bg-gradient-to-r from-[#22d3ee] to-[#0ea5e9] h-2.5 rounded-full transition-all duration-500" style={{ width: `${(media.length / 10) * 100}%` }}></div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative group border-2 border-dashed border-zinc-700 hover:border-[#22d3ee] rounded-lg p-4 transition-all bg-zinc-800/30 text-center cursor-pointer">
                      <input
                        type="file"
                      ...
                      <div className="flex flex-col items-center justify-center space-y-2 pointer-events-none">
                        <svg className="w-8 h-8 text-zinc-500 group-hover:text-[#22d3ee] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 bg-zinc-800/70 border border-zinc-700 rounded-lg text-white placeholder-zinc-555 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#22d3ee] focus:border-transparent transition-all"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 rounded-lg font-bold flex items-center justify-center gap-2 cursor-pointer transition-all shadow-md ${
                      !file
                        ...
                        : "bg-[#22d3ee] text-white hover:bg-[#22d3ee] shadow-[#22d3ee]/10 hover:shadow-[#22d3ee]/20 active:scale-[0.99]"
                    }`}
                  >
                    {caricamentoMedia ? (
                      <>
              ...
              {/* Galleria Media */}
              <div id="galleria-media" className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 shadow-xl backdrop-blur-sm scroll-mt-24">
                <h2 className="text-xl font-bold text-white mb-4 border-b border-zinc-800 pb-2 flex items-center gap-2">
                  <svg className="w-5 h-5 text-[#22d3ee]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                        ...
                        <div className="aspect-square relative flex items-center justify-center overflow-hidden bg-black/40">
                          {m.tipo === "audio" ? (
                            <div className="flex flex-col items-center justify-center w-full h-full p-4 bg-zinc-900">
                              <svg className="w-12 h-12 text-[#22d3ee] mb-4" fill="currentColor" viewBox="0 0 24 24">
                          ...
                          {/* overlay con bottoni */}
                          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-3 pointer-events-none">
                            <div className="flex justify-end gap-2 pointer-events-auto">
                              <button
                                ...
                                className="p-1.5 bg-zinc-700/90 text-white rounded-lg hover:bg-zinc-600 transition-colors shadow-lg cursor-pointer"
                                title="Ingrandisci"
                              >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              ...
                              {m.tipo === "immagine" && (
                                <button
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    setImmagineProfilo(m.source);
                                    setMessaggio("Immagine di profilo aggiornata (ricorda di salvare!)");
                                    setTimeout(() => setMessaggio(""), 4000);
                                  }}
                                  className="p-1.5 bg-[#0ea5e9]/90 text-white rounded-lg hover:bg-[#0ea5e9] transition-colors shadow-lg cursor-pointer"
                                  title="Imposta come immagine profilo"
                                >
                                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="max-w-5xl max-h-[85vh] w-full flex items-center justify-center relative" onClick={(e) => e.stopPropagation()}>
            {mediaEsteso.tipo === "video" ? (
              ...
              <div className="bg-zinc-900 p-8 rounded-2xl w-full max-w-md shadow-2xl text-center border border-zinc-800">
                 <svg className="w-24 h-24 mx-auto text-[#22d3ee] mb-6" fill="currentColor" viewBox="0 0 24 24">
                   <path d="M9 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h6V3H9z" />
                 </svg>
