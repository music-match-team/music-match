...
export default function AdminSidebar() {
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-zinc-900 border-b border-zinc-800 flex items-center justify-between px-4 z-40">
        <button
        ...
        <div className="w-8 h-8 rounded-full bg-violet-600/20 border border-violet-700/50 flex items-center justify-center">
      ...
      {/* Sidebar Aside */}
      <aside className={`w-64 min-h-screen bg-zinc-900 border-r border-zinc-800 flex flex-col fixed top-0 left-0 z-50 transition-transform duration-300 lg:translate-x-0 ${
        ...
        <div className="px-6 py-5 border-b border-zinc-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-zinc-500 text-xs">MusicMatch</p>
            </div>
          </div>
        ...
        <div className="px-6 py-4 border-b border-zinc-800">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-zinc-500 text-xs">{admin.isSuperAdmin ? "Super Admin" : "Amministratore"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-3 py-4 border-t border-zinc-800">
          <button
            onClick={logout}
            className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-zinc-400 hover:bg-red-900/20 hover:text-red-400 border border-transparent hover:border-red-900/40 transition-all cursor-pointer"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
